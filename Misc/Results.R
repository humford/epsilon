...
MicroImmune <- matrix(c(0,0,10,0,0,5,0,0,1,0,0,0,0,0,9), nrow = 3)
...
MicroMetabolism <- matrix(c(5,0,0,7,0,0,0,0,2,10,2,0,9,0,0), nrow = 3)
...
AML_6891Metabolism <- matrix(c(7,10,0,9,4,0,10,8,0,10,4,0), nrow = 3)
colnames(AML_6891Metabolism) <- c("GBM", "OV", "LumA", "AML NK")
rownames(AML_6891Metabolism) <- c("DOWN", "MIDDLE", "UP")

AML_15434MicroMetabolism <- matrix(c(6,0,0,7,0,0,6,0,0,0,4,10), nrow = 3)
